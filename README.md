...
ビルド済みアプリでOCR機能を使用するには、バックエンドサーバーのデプロイが必要です。

詳細な手順はこちら: **[バックエンドデプロイ手順書](./DEPLOYMENT.md)**

### 主なデプロイ選択肢
- **Vercel**（推奨）- 無料プランあり、簡単デプロイ
- **Railway** - Node.js最適化
- **Docker** - 自前サーバーで完全なコントロール

### デプロイの基本手順
1. バックエンドをクラウドにデプロイ
2. アプリのAPI接続先を本番URLに変更
3. アプリを再ビルド

### コスト considerations
- **Vercel**: 無料プランで個人利用可能
- **Google Vision API**: 月1000リクエストまで無料
